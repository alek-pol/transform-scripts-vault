...
describe('ut_v_list_barcodes.js', () => {
  const group = 'barcodes';
  const scriptName = 'ut_v_list_barcodes';
  ...
  describe('request transformation', () => {
    ...
    it('builds correct OData query with string filter', () => {
      ...
      DATA["$filter"] = filter
      expected["ut_Catalog_НоменклатураКонтрагентов_ДругиеШтрихкодыНоменклатуры"]["$filter"] = filter
