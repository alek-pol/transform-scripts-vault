...
describe('unf_v_list_units.js', () => {
  const group = 'units';
  const scriptName = 'unf_v_list_units';
  ...
  describe('request transformation', () => {
    ...
    it('builds correct OData query with filter', () => {
      ...
      DATA["$filter"] = filter
      expected["unf_list_Catalog_ЕдиницыИзмерения"]["$filter"] = filter
      expected["unf_list_Catalog_КлассификаторЕдиницИзмерения"]["$filter"] = filter
  ...
  describe('response transformation', () => {
    it('maps to unified listUnits format', () => {
