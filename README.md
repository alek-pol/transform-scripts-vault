...
Репозиторий js-скриптов трансформации данных, используемых [**сервисом внешнего взаимодействия Connect**](https://ekzo.dev/service/connect) для преобразования запросов и ответов между:
